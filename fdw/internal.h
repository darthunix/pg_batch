...
extern const PgBatchBridgeAPI *pg_batch_fdw_bridge;
extern const PgBatchBridgeProviderOps pg_batch_fdw_provider_ops;
...
extern PgBatchFdwScan *pg_batch_fdw_scan_begin(
	...
	List *source_exprs, const PgBatchBridgeRequest *request,
	MemoryContext query_context);
extern PgBatchBridgeBatch *pg_batch_fdw_scan_next(PgBatchFdwScan *scan);
